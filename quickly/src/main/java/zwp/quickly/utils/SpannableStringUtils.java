 ...
 * <p>    note： 使用方法
 * new SpannableStringUtils.Builder().append("第一部分文字").setForegroundColor(Color.BLACK).create();
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(Quickly.getContext(), bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(Quickly.getContext(), uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(Quickly.getContext(), resourceId, align), start, end, flag);
                    resourceId = 0;
