...
public class ToastUtils {
    ...
    private static int yOffset = (int) (64 * Quickly.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate = (LayoutInflater) Quickly.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
     ...
     * @param text 文本
     */
    public static void showShortSafe(final Object text) {
     ...
     * @param text 文本
     */
    public static void showLongSafe(final Object text) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    private static void show(@StringRes int resId, int duration) {
        show(Quickly.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(Quickly.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        cancel();
        if (customView != null) {
            sToast = new Toast(Quickly.getContext());
            sToast.setView(customView);
            sToast.setDuration(duration);
        } else {
            sToast = Toast.makeText(Quickly.getContext(), text, duration);
        }
