    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && Quickly.getContext().getExternalCacheDir() != null)
                dir = Quickly.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = Quickly.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
