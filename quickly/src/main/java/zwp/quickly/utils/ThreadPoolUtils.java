 ...
 * <p>describe：线程池相关工具类
 * <p>    note：
 * <p>  author：zwp on 2017/5/4 mail：1101558280@qq.com web: http://www.zwping.win </p>
 * <table>
 * <tr>
 * <th>
 * ThreadPoolUtils构造函数 {@link #ThreadPoolUtils(int, int)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 在未来某个时间执行给定的命令 {@link #execute(Runnable)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 在未来某个时间执行给定的命令链表 {@link #execute(Runnable)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 待以前提交的任务执行完毕后关闭线程池 {@link #shutDown()}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 试图停止所有正在执行的活动任务 {@link #shutDownNow()}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 判断线程池是否已关闭 {@link #isShutDown()}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 关闭线程池后判断所有任务是否都已完成 {@link #isTerminated()}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 请求关闭、发生超时或者当前线程中断 {@link #awaitTermination(long, TimeUnit)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 提交一个Callable任务用于执行 {@link #submit(Callable)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 提交一个Runnable任务用于执行 {@link #submit(Runnable, Object)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 执行给定的任务 {@link #invokeAll(Collection)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 延迟执行Runnable命令 {@link #schedule(Callable, long, TimeUnit)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 延迟并循环执行命令 {@link #scheduleWithFixedRate(Runnable, long, long, TimeUnit)}
 * </th>
 * </tr>
 * <tr>
 * <th>
 * 延迟并以固定休息时间循环执行命令 {@link #scheduleWithFixedDelay(Runnable, long, long, TimeUnit)}
 * </th>
 * </tr>
 * </table>
 *
