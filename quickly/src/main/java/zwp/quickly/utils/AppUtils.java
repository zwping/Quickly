 ...
 * <table>
 *     <tr>
 *         <th>判断APP是否安装{@link AppUtils#isInstallApp(Context, String)}</th>
 *     </tr>
 *     <tr>
 *         <th>安装App（支持6.0）{@link AppUtils#installApp(Context, String)}</th>
 *     </tr>
 *     <tr>
 *         <th>安装App（支持6.0），有返回值{@link AppUtils#installApp(Activity, String, int)}</th>
 *     </tr>
 *     <tr>
 *         <th>静默安装App(需要权限){@link AppUtils#installAppSilent(Context, String)}</th>
 *     </tr>
 *     <tr>
 *         <th>卸载App{@link AppUtils#uninstallApp(Context, String)}</th>
 *     </tr>
 *     <tr>
 *         <th>卸载App，有返回值{@link AppUtils#uninstallApp(Activity, String, int)}</th>
 *     </tr>
 *     <tr>
 *         <th>静默卸载APP（需要权限）{@link AppUtils#uninstallAppSilent(Context, String, boolean)}</th>
 *     </tr>
 *     <tr>
 *         <th>判断App是否有root权限{@link AppUtils#isAppRoot()}</th>
 *     </tr>
 *     <tr>
 *         <th>打开App{@link AppUtils#launchApp(Context, String)}</th>
 *     </tr>
 *     <tr>
 *         <th>打开APP，有返回值{@link AppUtils#launchApp(Activity, String, int)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App包名{@link AppUtils#getAppPackageName(Context)} </th>
 *     </tr>
 *     <tr>
 *         <th>获取App具体设置,跳转至APP的应用信息{@link AppUtils#getAppDetailsSettings(Context)} </th>
 *     </tr>
 *     <tr>
 *         <th>获取App名称{@link AppUtils#getAppName(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App图标{@link AppUtils#getAppIcon(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App路径{@link AppUtils#getAppPath(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App版本号{@link AppUtils#getAppVersionName(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App版本码{@link AppUtils#getAppVersionCode(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>判断App是否是系统应用{@link AppUtils#isSystemApp(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>判断App是否是Debug版本{@link AppUtils#isAppDebug(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App签名{@link AppUtils#getAppSignature(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取应用签名的的SHA1值{@link AppUtils#getAppSignatureSHA1(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>判断App是否处于前台{@link AppUtils#isAppForeground(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取App信息{@link AppUtils#getAppInfo(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>获取当前手机所有已安装App信息{@link AppUtils#getAppsInfo(Context)}</th>
 *     </tr>
 *     <tr>
 *         <th>判断是否是一个系统的应用软件{@link #isSystemApp(Context)}</th>
 *     </tr>
 * </table>
 */
...
public class AppUtils {
    ...
    public static void installApp(Context context, File file) {
        if (!FileUtils.isFileExists(file.getPath())) return;
    ...
    public static boolean installAppSilent(Context context,String filePath) {
        ...
        if (!FileUtils.isFileExists(file.getPath())) return false;
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            Logger.i("isAppRoot", result.errorMsg);
        }
        return false;
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (StringUtils.isEmpty(packageName)) return;
        IntentUtils.openAppDetail(packageName,context);
    }
    ...
    public static boolean isAppDebug(Context context) {
        return isAppDebug(Quickly.getContext(), Quickly.getContext().getPackageName());
    }
