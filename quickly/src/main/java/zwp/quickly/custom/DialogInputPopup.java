...
import zwp.quickly.widget.CommEditText;
...
public class DialogInputPopup extends BasePopupWindow {

    private RelativeLayout mPopupDismiss = null;
    private TextView mTitle = null;
    private TextView mContent = null;
    private CommEditText mEditText = null;
     ...
     */
    public DialogInputPopup(Activity activity, String editText, String editTextHint, String title, String cancel, String complete, final OnClickListenerInterface1 completeDismissObserver) {
        super(activity);
        initView();
        if (mPopupView != null) {
    ...
    protected Animator initExitAnimator() {
        return getDefaultSlideFromTopAnimationSet(mAnimaView);
    }
}
